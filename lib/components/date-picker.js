...
exports.default = {
    ...
    methods: {
        ...
        initDays: async function initDays() {
            var date = this.date;
        ...
        clearDate: async function clearDate() {
            var _this = this;

            this.selectedDate = '';
            this.shown = false;
            await this.$nextTick(async function () {
                await _this.initDays();
            });
        }
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a4bb927a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(18);
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_711c97e2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_date_panel_vue__ = __webpack_require__(17);
var normalizeComponent = __webpack_require__(0)
/* script */
